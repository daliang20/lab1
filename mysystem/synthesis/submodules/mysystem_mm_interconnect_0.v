...
module mysystem_mm_interconnect_0 (
	...
	wire  [124:0] ram_s1_agent_rp_data;                                          // ram_s1_agent:rp_data -> router_002:sink_data
	...
	wire          new_sdram_controller_0_s1_agent_rp_valid;                      // new_sdram_controller_0_s1_agent:rp_valid -> router_003:sink_valid
	wire  [106:0] new_sdram_controller_0_s1_agent_rp_data;                       // new_sdram_controller_0_s1_agent:rp_data -> router_003:sink_data
	wire          new_sdram_controller_0_s1_agent_rp_ready;                      // router_003:sink_ready -> new_sdram_controller_0_s1_agent:rp_ready
	wire          new_sdram_controller_0_s1_agent_rp_startofpacket;              // new_sdram_controller_0_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          new_sdram_controller_0_s1_agent_rp_endofpacket;                // new_sdram_controller_0_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [124:0] ram_s1_burst_adapter_source0_data;                             // ram_s1_burst_adapter:source0_data -> ram_s1_agent:cp_data
	...
	wire  [106:0] new_sdram_controller_0_s1_burst_adapter_source0_data;          // new_sdram_controller_0_s1_burst_adapter:source0_data -> new_sdram_controller_0_s1_agent:cp_data
	...
	wire          router_002_src_valid;                                          // router_002:src_valid -> ram_s1_rsp_width_adapter:in_valid
	wire  [124:0] router_002_src_data;                                           // router_002:src_data -> ram_s1_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                          // ram_s1_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                        // router_002:src_channel -> ram_s1_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                                  // router_002:src_startofpacket -> ram_s1_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                    // router_002:src_endofpacket -> ram_s1_rsp_width_adapter:in_endofpacket
	wire          ram_s1_rsp_width_adapter_src_valid;                            // ram_s1_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [232:0] ram_s1_rsp_width_adapter_src_data;                             // ram_s1_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          ram_s1_rsp_width_adapter_src_ready;                            // rsp_demux:sink_ready -> ram_s1_rsp_width_adapter:out_ready
	wire    [1:0] ram_s1_rsp_width_adapter_src_channel;                          // ram_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          ram_s1_rsp_width_adapter_src_startofpacket;                    // ram_s1_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          ram_s1_rsp_width_adapter_src_endofpacket;                      // ram_s1_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	wire          router_003_src_valid;                                          // router_003:src_valid -> new_sdram_controller_0_s1_rsp_width_adapter:in_valid
	wire  [106:0] router_003_src_data;                                           // router_003:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                          // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                        // router_003:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                  // router_003:src_startofpacket -> new_sdram_controller_0_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                    // router_003:src_endofpacket -> new_sdram_controller_0_s1_rsp_width_adapter:in_endofpacket
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_valid;         // new_sdram_controller_0_s1_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [232:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;          // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_ready;         // rsp_demux_001:sink_ready -> new_sdram_controller_0_s1_rsp_width_adapter:out_ready
	wire    [1:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;       // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_startofpacket; // new_sdram_controller_0_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          new_sdram_controller_0_s1_rsp_width_adapter_src_endofpacket;   // new_sdram_controller_0_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_src_valid;                                             // cmd_mux:src_valid -> ram_s1_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_src_data;                                              // cmd_mux:src_data -> ram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                             // ram_s1_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                           // cmd_mux:src_channel -> ram_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                     // cmd_mux:src_startofpacket -> ram_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                       // cmd_mux:src_endofpacket -> ram_s1_cmd_width_adapter:in_endofpacket
	wire          ram_s1_cmd_width_adapter_src_valid;                            // ram_s1_cmd_width_adapter:out_valid -> ram_s1_burst_adapter:sink0_valid
	wire  [124:0] ram_s1_cmd_width_adapter_src_data;                             // ram_s1_cmd_width_adapter:out_data -> ram_s1_burst_adapter:sink0_data
	wire          ram_s1_cmd_width_adapter_src_ready;                            // ram_s1_burst_adapter:sink0_ready -> ram_s1_cmd_width_adapter:out_ready
	wire    [1:0] ram_s1_cmd_width_adapter_src_channel;                          // ram_s1_cmd_width_adapter:out_channel -> ram_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_001_src_valid;                                         // cmd_mux_001:src_valid -> new_sdram_controller_0_s1_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_001_src_data;                                          // cmd_mux_001:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                         // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                       // cmd_mux_001:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                                 // cmd_mux_001:src_startofpacket -> new_sdram_controller_0_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                   // cmd_mux_001:src_endofpacket -> new_sdram_controller_0_s1_cmd_width_adapter:in_endofpacket
	...
	wire  [106:0] new_sdram_controller_0_s1_cmd_width_adapter_src_data;          // new_sdram_controller_0_s1_cmd_width_adapter:out_data -> new_sdram_controller_0_s1_burst_adapter:sink0_data
